...
The OCD project uses the MIT license as its main license for its source code and
documentation. The project also uses the CC0-1.0 license to place files in the
public domain, which are considered to be to small, or to generic to place
copyright over.
...
project, and can be distributed with the project under its main license.
